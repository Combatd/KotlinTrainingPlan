...
// Shop.getCitiesCustomersAreFrom() and Shop.getCustomersFrom() 
...
// it refers to the current element of the list
...
fun Shop.getCustomersFrom(city: City): List<Customer> = customers.filter {
    it.city == city
} // only selects city that match it.city into the list